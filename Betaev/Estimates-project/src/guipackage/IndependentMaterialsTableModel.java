...
public class IndependentMaterialsTableModel  extends AbstractTableModel {
     ...
     */
    public IndependentMaterialsTableModel(DependenceDialog Dialog, MaterialDatabaseHelper mathelper, DependenciesDatabaseHelper dephelper, Algorithm Alg) throws SQLException {
        PartnerFrame = Dialog;
        SelectedAlg = Alg;
        //хелперы для работы с БД
        MDHelper = mathelper;
        DDHelper = dephelper;
        IdList = DDHelper.getDependentMaterialsIdList(SelectedAlg.getId());
    }

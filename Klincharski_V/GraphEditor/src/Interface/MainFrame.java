...
public class MainFrame extends JFrame {
    ...
    JToolBar toolbar;
    JButton openButton, saveButton, quitButton, verticeButton, edgeButton, cursorButton, newProjectButton;
    /** Слушатели */
    ...
    ActionListener newProjectListener;
    ...
    private void initToolBar() {
        ...
        newProjectButton = new JButton(new ImageIcon("newproject.png"));
        newProjectButton.addActionListener(newProjectListener);
    ...
    private void initListeners() {
        ...
        newProjectListener = new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                onRestart();
    ...
    public static void main(String[] args) {
        ...
        vertice vr1 = new vertice("first", 1, 1);
        vertice vr2 = new vertice("second", 1, 2);
        vertice vr3 = new vertice("third", 1, 3);
        
        edge ed1 = new edge(vr1, vr2, EdgeKind.NOTORIENTED, 1000);
        edge ed2 = new edge(vr2, vr3, EdgeKind.NOTORIENTED, 1500);
        gr1.addVertice(vr1);
        gr1.addVertice(vr2);
        gr1.addVertice(vr3);
        gr1.addEdge(ed1);
        ...
        System.out.println(gr1.minpath(gr1, vr1, vr3));
        /*
        int d[][] = new int[gr1.getVertice().size()][gr1.getVertice().size()];
        for (int i  = 0; i<gr1.getVertice().size();i++)
        {
            for (int n = 0;n<gr1.getVertice().size();n++)
            {
                edge ed  = new edge(gr1.getVertice().get(i), gr1.getVertice().get(n), EdgeKind.NOTORIENTED, 0);
                if (gr1.existEdge(ed)!=0) d[i][n] = gr1.existEdge(ed);
                else d[i][n] = 20000000;
            }
        }
